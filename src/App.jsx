...
const App = () => {
  ...
  return (
    <div className="flex h-screen items-center justify-center bg-[#EEF5FF]">
      <div className="flex h-[85%] w-[60%] rounded-xl bg-white shadow-lg">
        <div className="mb-6 ml-6 mt-6 flex w-[35%] flex-col gap-y-7 rounded-xl bg-blue-700 p-10">
          <div
            onClick={() => toggleTab(1)}
            className="justify-left flex cursor-pointer items-center gap-5"
          >
            <div
              className={`${toggle === 1 ? "flex h-6 w-6 items-center justify-center rounded-full bg-[#EEF5FF] p-[21.6px] text-[20px] font-medium text-blue-950" : "flex h-6 w-6 items-center justify-center rounded-full border-2 border-white p-5 text-[20px] font-medium text-white"}`}
            >
              1
            </div>
            <div>
          ...
          >
            <div
              className={`${toggle === 2 ? "flex h-6 w-6 items-center justify-center rounded-full bg-[#EEF5FF] p-[21.6px] text-[20px] font-medium text-blue-950" : "flex h-6 w-6 items-center justify-center rounded-full border-2 border-white p-5 text-[20px] font-medium text-white"}`}
            >
              2
            </div>
            <div>
          ...
          >
            <div
              className={`${toggle === 3 ? "flex h-6 w-6 items-center justify-center rounded-full bg-[#EEF5FF] p-[21.6px] text-[20px] font-medium text-blue-950" : "flex h-6 w-6 items-center justify-center rounded-full border-2 border-white p-5 text-[20px] font-medium text-white"}`}
            >
              3
            </div>
            <div>
          ...
          >
            <div
              className={`${toggle === 4 ? "flex h-6 w-6 items-center justify-center rounded-full bg-[#EEF5FF] p-[21.6px] text-[20px] font-medium text-blue-950" : "flex h-6 w-6 items-center justify-center rounded-full border-2 border-white p-5 text-[20px] font-medium text-white"}`}
            >
              4
            </div>
            <div>
          ...
          <div className={toggle === 2 ? "show-content" : "content"}>
            <div className="m-16">
              ...
              <div className="flex">
                <button
                  onClick={() => toggleTab(1)}
                  className=" absolute bottom-7 left-16 rounded-xl px-6 py-3 font-semibold  text-gray-400 outline-none hover:text-blue-950"
                >
                  Go Back
                </button>
                <button
